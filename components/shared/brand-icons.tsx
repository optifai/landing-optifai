...
/**
 * lucide-react v1 dropped its brand icons, so the two we need are inlined here.
 * Both are decorative by default (`aria-hidden`) — the accessible name always
 * comes from the surrounding link or button label.
 */
